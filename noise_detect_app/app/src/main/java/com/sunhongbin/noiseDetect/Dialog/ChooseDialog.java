package com.sunhongbin.noiseDetect.Dialog;
...
public class ChooseDialog extends Dialog {
    ...
    public void setChoose1(String choose1) {
        if(TextUtils.isEmpty(choose1))this.choose1.setVisibility(View.GONE);
        this.choose1.setText(choose1);
    }

    public void setChoose2(String choose2) {
        if(TextUtils.isEmpty(choose2))this.choose2.setVisibility(View.GONE);
        this.choose2.setText(choose2);
    }

    public void setChoose3(String choose3) {
        if(TextUtils.isEmpty(choose3))this.choose3.setVisibility(View.GONE);
