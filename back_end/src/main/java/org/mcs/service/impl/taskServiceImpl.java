...
public class taskServiceImpl implements TaskService {
    ...
    public TaskRecord create(TaskRecord taskRecord, Long userPhone) {
        //1、验证关键参数是否规范
        if (taskRecord.getPublisherId() == null || taskRecord.getTaskExecuteTime() == null
                || StringUtils.isBlank(taskRecord.getTaskDescription()) || StringUtils.isBlank(taskRecord.getTaskLocation())) {
        ...
        try {
            ...
            taskRecord.setCtime(publishTime);
